...
import onlineImage from "../assets/Images/onlineshopping.png"
  ...
  return (
    <SafeAreaView className="flex-1 px-5 bg-white">
      ...
      <View className="px-5">
        ...
        />
        <TouchableOpacity
          className="bg-purple-600 rounded-lg my-3"
          onPress={() => navigation.navigate("cart")}
        >
          <Text className="text-center text-white py-4 text-lg capitalize font-medium">
            next
          </Text>
        </TouchableOpacity>
      </View>
